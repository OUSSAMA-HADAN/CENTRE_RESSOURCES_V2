...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.recherche.update', $recherche) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $recherche->title) }}" required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="summary" name="summary" rows="3" required>{{ old('summary', $recherche->summary) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="15">{{ old('content', $recherche->content) }}</textarea>
                            @error('content')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="category" name="category" value="{{ old('category', $recherche->category) }}" required>
                                    @error('category')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="published_at" name="published_at" value="{{ old('published_at', $recherche->published_at ? $recherche->published_at->format('Y-m-d') : '') }}">
                                    @error('published_at')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_published" id="status-draft" value="0" {{ old('is_published', $recherche->is_published ? '1' : '0') == '0' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="status-draft">Brouillon</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_published" id="status-published" value="1" {{ old('is_published', $recherche->is_published ? '1' : '0') == '1' ? 'checked' : '' }}>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="current-image mb-3">
                                    ...
                                    <img src="{{ asset('storage/' . $recherche->cover_image) }}" class="img-fluid" style="max-height: 150px;" alt="Cover image">
                                </div>
                                @endif
                                
                                <div class="mb-3">
                                    <label for="cover_image" class="form-label">{{ $recherche->cover_image ? 'Changer l\'image' : 'Télécharger une image' }}</label>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="current-file mb-2">
                                    <p class="small text-muted mb-1">Fichier actuel:</p>
                                    <a href="{{ asset('storage/' . $recherche->pdf_file) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                ...
                                <div class="mb-3">
                                    <label for="pdf_file" class="form-label">{{ $recherche->pdf_file ? 'Remplacer le PDF' : 'PDF de la publication' }}</label>
